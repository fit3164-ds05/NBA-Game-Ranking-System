...
from data_prep import load_games, build_results
from engines import (
    RatingEngine,
    GlickoEngine,
    EloEngine,
...
_games = load_games()
results_df = build_results(_games)
...
def run_engine(engine_name: str, factory) -> pd.DataFrame:
    """Run an engine through all matches, save CSV and plot, and return the ratings."""
...
# Utility for win probability on specific dates
