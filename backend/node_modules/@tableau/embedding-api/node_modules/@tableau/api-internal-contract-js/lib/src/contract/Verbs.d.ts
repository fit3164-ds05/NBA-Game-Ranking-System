export declare enum VerbId {
    ...
    AddMarksCardFields = "add-marks-card-fields",
    AppendExternalMenuItem = "append-external-menu-item",
    ApplyCategoricalFilter = "categorical-filter",
    ApplyPulseFilters = "apply-pulse-filters",
    ApplyPulseTimeDimension = "apply-pulse-time-dimension",
    ...
    ClearAllPulseFilters = "clear-all-pulse-filters",
    ClearFilter = "clear-filter",
    ClearPulseFilters = "clear-pulse-filters",
    ...
    EditAliasesDialog = "edit-aliases-dialog",
    ...
    GetVizStateWithDataModel = "get-viz-state-with-data-model",
    ...
    GetVisualSpecification = "get-visual-specification",
    ...
    GetPulseCategoricalDomain = "get-pulse-categorical-domain",
    GetPulseFilters = "get-pulse-filters",
    GetPulseTimeDimension = "get-pulse-time-dimension",
    ...
    MoveMarksCardField = "move-marks-card-field",
    RaiseLeaveMarkNavNotification = "raise-leave-mark-nav-notification",
    RaiseHoverTupleNotification = "raise-hover-tuple-notification",
    RaiseSelectTuplesNotification = "raise-select-tuples-notification",
    Redo = "redo",
    ...
    SetVizStateWithDataModel = "set-viz-state-with-data-model",
    SetSheetSize = "set-sheet-size",
    SetZoneVisibility = "set-zone-visibility",
    Share = "share",
    ShowCustomView = "show-custom-view",
    SpliceMarksCardFields = "splice-marks-card-fields",
